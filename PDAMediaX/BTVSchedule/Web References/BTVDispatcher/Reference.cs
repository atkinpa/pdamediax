...
namespace BTVSchedule.BTVDispatcher {
    using System;
    ...
    public partial class BTVDispatcher : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public BTVDispatcher() {
            this.Url = global::BTVSchedule.Properties.Settings.Default.BTVSchedule_BTVDispatcher_BTVDispatcher;
        ...
        public PVSPropertyBag[] GetActiveRecordings(string authTicket) {
            object[] results = this.Invoke("GetActiveRecordings", new object[] {
                        authTicket});
            return ((PVSPropertyBag[])(results[0]));
        }
        
        /// <remarks/>
        public void GetActiveRecordingsAsync(string authTicket) {
            this.GetActiveRecordingsAsync(authTicket, null);
        }
        
        /// <remarks/>
        public void GetActiveRecordingsAsync(string authTicket, object userState) {
            ...
            this.InvokeAsync("GetActiveRecordings", new object[] {
                        authTicket}, this.GetActiveRecordingsOperationCompleted, userState);
        }
        ...
        public PVSPropertyBag[] GetActiveRecordingsWithChannel(string authTicket, string uniqueChannelID) {
        ...
        /// <remarks/>
        public void GetActiveRecordingsWithChannelAsync(string authTicket, string uniqueChannelID) {
            this.GetActiveRecordingsWithChannelAsync(authTicket, uniqueChannelID, null);
        }
        
        /// <remarks/>
        public void GetActiveRecordingsWithChannelAsync(string authTicket, string uniqueChannelID, object userState) {
        ...
        public PVSPropertyBag[] GetEngines(string authTicket) {
        ...
        /// <remarks/>
        public void GetEnginesAsync(string authTicket) {
            this.GetEnginesAsync(authTicket, null);
        }
        
        /// <remarks/>
        public void GetEnginesAsync(string authTicket, object userState) {
            ...
            this.InvokeAsync("GetEngines", new object[] {
                        authTicket}, this.GetEnginesOperationCompleted, userState);
        }
        ...
        public PVSPropertyBag[] GetEnginesWithChannel(string authTicket, string uniqueChannelID) {
        ...
        /// <remarks/>
        public void GetEnginesWithChannelAsync(string authTicket, string uniqueChannelID) {
            this.GetEnginesWithChannelAsync(authTicket, uniqueChannelID, null);
        }
        
        /// <remarks/>
        public void GetEnginesWithChannelAsync(string authTicket, string uniqueChannelID, object userState) {
        ...
        public void SetSources(string authTicket, PVSPropertyBag[] sources) {
        ...
        /// <remarks/>
        public void SetSourcesAsync(string authTicket, PVSPropertyBag[] sources) {
            this.SetSourcesAsync(authTicket, sources, null);
        }
        
        /// <remarks/>
        public void SetSourcesAsync(string authTicket, PVSPropertyBag[] sources, object userState) {
